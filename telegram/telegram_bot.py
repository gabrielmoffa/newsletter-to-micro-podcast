...
class TelegramBot:
    ...
    def send_podcast_episode(self, chat_id: str, audio_path: str, episode_title: str = "Daily Newsletter Podcast", newsletter_url: str = None, summary: str = None) -> dict:
        """
        ...
        Args:
            ...
            summary: Short written summary of the newsletter highlights
        ...
        caption += "\n🔔 We publish Monday, Wednesday, and Friday at 7AM."
